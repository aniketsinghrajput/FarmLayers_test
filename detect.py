...
def run(weights='best.pt',     # model.pt path(s)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if save_img:
                if dataset.mode == 'image':
                    ...
                    print('save_path',save_path,'imo',type(im0))
    ...
    if save_txt or save_img:
        ...
        print('aaaaaaaaaaaaa')
        print('returnfarm',farms)
        # app.appvar=farms
        # upvar.no_of_farms=farms
       # return farms
    if update:
...
def main(opt):
    ...
    # t=main.x
    # farm()
    # print('nnnnnnnnnnnnnnnnnnnnnnn',main.x)
    # # print('xxxxxxxxxxx',x)
    # return t
    #print('xxxxxxxxxxx',x)
